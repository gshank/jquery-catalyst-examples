...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{JQUERY_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{JQUERY_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
jquery_server.pl - Catalyst Testserver

=head1 SYNOPSIS

jquery_server.pl [options]
